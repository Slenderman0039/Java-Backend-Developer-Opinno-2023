...
public class MainInsertion {
    public static void main(String[] args) {
        ...
        System.out.println("-----Insertion Sort Array[10]-----");


        //CASO MEDIO: ARRAY GENERATO RANDOMICAMENTE

        startTime = System.nanoTime();
        SortingAlgorithms.insertionSort(arr_dieci);
        ...
        startTime = System.nanoTime();
        SortingAlgorithms.insertionSort(arr_dieci_contrario);
        estimatedTime = System.nanoTime() - startTime;
        ...
        System.out.println("-----Insertion Sort Array[1.000]-----");


        //CASO MEDIO: ARRAY GENERATO RANDOMICAMENTE

        startTime = System.nanoTime();
        SortingAlgorithms.insertionSort(arr_mille);
        estimatedTime = System.nanoTime() - startTime;
        ...
        startTime = System.nanoTime();
        SortingAlgorithms.insertionSort(arr_mille_contrario);
        estimatedTime = System.nanoTime() - startTime;
        ...
        System.out.println("-----Insertion Sort Array[1.000.000]-----");


        //CASO MEDIO: ARRAY GENERATO RANDOMICAMENTE

        startTime = System.nanoTime();
        SortingAlgorithms.insertionSort(arr_milione);
        estimatedTime = System.nanoTime() - startTime;
        ...
        startTime = System.nanoTime();
        SortingAlgorithms.insertionSort(arr_milione_contrario);
        estimatedTime = System.nanoTime() - startTime;
