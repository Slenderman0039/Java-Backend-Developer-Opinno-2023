...
/*Esercizio Distributore di Bevande 🛵
        ...
        Scrivere un programma in grado di modellare la gestione di un distributore di bevande. Il distributore gestirà una lista
        di 2 tipi diversi di prodotti: Caffè e Cappuccino.
...
public class Main1 {
    ...
    public static void main(String[] args) {
        ...
        distributoreDiBevande.caricaProdotto(cappuccino);
        distributoreDiBevande.caricaProdotto(caffe);
        System.out.println(distributoreDiBevande.toString());
        ...
        System.out.println("Saldo: " + distributoreDiBevande.saldoAttuale());
        System.out.println(distributoreDiBevande.scegliProdotto("caffe") != null);
        System.out.println("Saldo: " + distributoreDiBevande.saldoAttuale());
